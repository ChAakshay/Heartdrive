...
def user_side():
    ...
    cholesterol_mapping = {"Low: <200": 1, "Medium: 200-239": 2, "High: >=240": 3}
    glucose_mapping = {"Low: <70": 1, "Medium: 70-99": 2, "High: >=100": 3}
    ...
    user_data = {
        ...
        "cholesterol": cholesterol_mapping[st.selectbox("Cholesterol Level (mm/dL)", list(cholesterol_mapping.keys()), index=0)],
        "gluc": glucose_mapping[st.selectbox("Glucose Level (mm/dL)", list(glucose_mapping.keys()), index=0)],
